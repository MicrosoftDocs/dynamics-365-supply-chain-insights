...
Entities are collections of attributes that are used to organize data in Dynamics 365 Supply Chain Insights. Organized data is critical in driving Supply Chain Insights to effectively present supply chain information so that it can be analyzed for insights.

## Definition

Supply Chain Insights organizes its data with labels to analyze it for insights. To do so, Supply Chain Insights has users ingest data by entities, whcih are collections of attributes that together make up a concept. For example, a vendor is an entity containing attributes related to their name, location, and other characteristics. Supply Chain Insights contains many of these entities to represent different parts of a supply chain, and each of these entities have attributes to describe them. A complete list of entities and their attributes are listed in the following tables.
...
A *warehouse* entity captures the details for a warehouse, such as its contact information and location.
...
| RegionalLongitude    | Will be autopopuluted.                                                     | String | Optional     |
| RegionalLatitude     | Will be autopopuluted.                                                     | String | Optional     |

### Products

#### Item

An *item* entity captures the physical representation details of a good in a warehouse or production plant. A good can be a finished product, a part, or raw material.
...
A *product* entity captures the details of end products that a company produces and sells to their customers.
...
A *customer* entity to captures the details of customers that a company sells their end products to. 
...
A *vendor* entity captures the details of vendors that supply raw materials or components that are needed for manufacturing a company’s products.  
...
An *order* entity captures details about purchase and sales orders. 
...
An *order line* entity captures the order line details for each purchase and sales order. 
...
A *shipment item* entity captures details about what part of an order is contained in a single shipment.
...
A *shipment* entity captures details about inbound and outbound shipments associated with a warehouse.  
...
A *customer product allocation* entity captures the quantities allocated for customers to satisfy anticipated demand. This is capturing the committed supply.  
...
A *master plan schedule* entity captures the build plan details, including what is being produced, in what quantity, and when.
...
A *material resource plan* entity captures the details of the material resource plan that contains the quantity of items required to satisfy demand for an end product and to achieve the master plan schedule.  
...
A *warehouse item available stock* entity captures the details of available stock in warehouses.  
