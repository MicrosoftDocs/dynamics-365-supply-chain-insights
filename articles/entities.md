...
| RegionalLatitude     |                                                                          | String | Optional     |
...
| Quantity                   | N/A for April release                                                            | Integer         | Optional |
...
| PlannedShipmentDate                |                                                                                | ISO 8601 format | Required |
| PlannedPickDate                    | N/A for April release                                                          | ISO 8601 format | Optional |
| CommittedDeliveryDate              |                                                                                | ISO 8601 format | Optional |
| RequestedDeliveryDate              |                                                                                | ISO 8601 format | Required |
| ActualPickTimestamp                | N/A for April release                                                          | ISO 8601 format | Optional |
| ActualShipmentTimestamp            |                                                                                | ISO 8601 format | Optional |
| OrderLineQuantityUnitOfMeasurement |                                                                                | String          | Optional |
| OrderLineQuantity                  |                                                                                | Integer         | Optional |
| ReturnedQuantity                   | N/A for April release                                                          | Integer         | Optional |
| CancelledQuantity                  |                                                                                | Integer         | Optional |
...
| ItemId 	                             | Identifier for the item  	                                                         | String          | Required     |
...
| PeriodStartDate                      |                                                                                     | ISO 8601 format | Required     | 
...
| ActualStartDate                 |                                                                               | ISO 8601 format | Optional |
| ActualEndDate                   |                                                                               | ISO 8601 format | Optional |
| OrderPlannedStartDate           |                                                                               | ISO 8601 format | Optional |
| OrderActualStartDate            |                                                                               | ISO 8601 format | Optional |
...
| FillRatePercentage            | (N/A for this release)                                                   | Integer         | Optional     |
